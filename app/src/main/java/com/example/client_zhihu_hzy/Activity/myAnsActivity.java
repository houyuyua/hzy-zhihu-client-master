...
public class myAnsActivity extends AppCompatActivity implements View.OnClickListener {
...
//                break;
            ...
            case R.id.bt_Mine:
                Intent intentHome = new Intent( myAnsActivity.this, MineActivity.class);
...
//        List<SingleAnswerData> answersList = answersListReturnData.getData();//回答列表提取成功
        ...
        for(int i = 0; i< answersList.size(); i++){
            if(answersList.get(i).getCreator().getId()==7) {
...
//                    textViewAnswers.setText(answersCount+"回答");
                    Toast.makeText(myAnsActivity.this, "回答列表加载成功", Toast.LENGTH_LONG).show();
                }
